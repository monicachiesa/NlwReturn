...
export function ScreenshotButton({ screenshot, onScreenshotTook }: ScreenshotButtonProps) {
    ...
    async function handleTakeScreenshot() {
        ...
        const canvas = await html2canvas(document.querySelector('html')!)  //pega todo o conteúdo, pois tudo está
        //dentro da tag "html"
        const base64image = canvas.toDataURL('image.png');  //converte a imagem para o formato base64
